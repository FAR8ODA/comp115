...
def draw_picture():
    ...
    colours = ["red", "pink","purple", "blue", "green", "yellow", "orange"]
    decrease_amounts = [4, 10, 5, 19, 20]
    
    Farbod = turtle.Turtle()
    Farbod.speed(0)
    
    for i in range(5):
        Farbod.color(colours[i % len(colours)])
        draw_special(Farbod, 100, 10, decrease_amounts[i % len(decrease_amounts)])
