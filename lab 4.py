...
assert (average([1,3,5,6,8,9])== 5.33)
assert (average([70,77,68,81])== 74)
assert (average([100,100,100])== 100)
"""
...
assert (find_max([23,66,87,1003])== 1003)
assert (find_max([245])==245)
"""
Exercise 5 (15 marks) 
...
assert (sum_of_squares([5, 7, 4])== 90)
assert (sum_of_squares([10, 100, 1000])== 1010100)
"""
Exercise 7 (20 marks) 
...
assert (squares([10,100,1000]) == [100,10000,1000000])
"""
